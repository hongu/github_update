...
extern uint8_t can1Tx1Data[8];

extern CAN_FilterTypeDef Can2Filter;
extern CAN_RxHeaderTypeDef can2RxHeader;
extern CAN_TxHeaderTypeDef can2TxHeader;
extern uint32_t txMailBox2;

extern uint8_t can2Rx0Data[8];
extern uint8_t can2Rx1Data[8];
extern uint8_t can2Tx0Data[8];
extern uint8_t can2Tx1Data[8];
