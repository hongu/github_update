...
uint8_t can1Rx0Data[8] = {0};
uint8_t can1Rx1Data[8] = {0};
uint8_t can1Tx0Data[8] = {0};
uint8_t can1Tx1Data[8] = {0};
...
uint8_t can2Rx0Data[8] = {0};
uint8_t can2Rx1Data[8] = {0};
uint8_t can2Tx0Data[8] = {0};
uint8_t can2Tx1Data[8] = {0};
